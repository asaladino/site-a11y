...
class HtmlRepository {
  ...
  file(url) {
    return _path.default.join(this.getProjectsHtmlFolder(), url.name + '.html');
  }
  /**
  ...
  getProjectsHtmlFolder() {
    let projectsPathHtml = _path.default.join(this.projectFolder, 'html');

    if (!_fs.default.existsSync(projectsPathHtml)) {
      _fs.default.mkdirSync(projectsPathHtml);
    }
